...
print("WarBoard: Live updates ")
while True:
    try: 
        data_option = int(input("WarBoard: Enter 1 for live data. Enter 2 for example data: "))
...
if data_option == 1:
    while True:
        updated_etag = API.get_etag(constant.BASE_API_URL, constant.WARREPORT_MODIFIER)
        if etag != updated_etag:
            ...
            print("WarBoard: No new data found...\nWarBoard: Next fetch in 10 minutes")
